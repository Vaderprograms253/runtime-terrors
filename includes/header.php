                        ...
                        <div id="menuBtnDiv" class="dropdown d-inline input-group-text">
                            ...
                            <ul id="dropdownList" class="dropdown-menu" aria-labelledby="searchOptions">
                                ...
                                <div class="row px-2">
                                    <div class="col-6">
                                        <label>
                                            <input id="org-filter" type="checkbox">
                                            Organization
                                        </label>
                                    </div>
                                    <div class="col-6">
                                        <label>
                                            <input id="location-filter" type="checkbox">
                                            Location
                                        </label>
                                    </div>
                                </div>
                                ...
                                <div class="row px-2">
                                    <div class="col-6">
                                        <label>
                                            <input id="med-phone-filter" type="checkbox">
                                            Phone
                                        </label>
                                    </div>
                                    <div class="col-6">
                                        <label>
                                            <input id="med-fax-filter" type="checkbox">
                                            Fax
                                        </label>
                                    </div>
                                </div>
                                ...
                                <div class="row px-2">
                                    <div class="col-6">
                                        <label>
                                            <input id="film-phone-filter" type="checkbox">
                                            Phone
                                        </label>
                                    </div>
                                    <div class="col-6">
                                        <label>
                                            <input id="film-fax-filter" type="checkbox">
                                            Fax
                                        </label>
                                    </div>
                                </div>
                                <div class="row px-2">
                                    <div class="col-6">
                                        <label>
                                            <input id="push-filter" type="checkbox">
                                            Push
                                        </label>
                                    </div>
                                    <div class="col-6">
                                        <label>
                                            <input id="image-type-filter" type="checkbox">
                                            Image Type
                                        </label>
                                    </div>
                                </div>
